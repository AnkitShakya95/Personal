...
OWNER = int(os.environ.get("OWNER", 7341059064))
try: 
    ADMINS=[] 
    for x in (os.environ.get("ADMINS", "7341059064").split()):  
        ADMINS.append(int(x)) 
except ValueError: 
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "visionias" in url:
             ...
             vid_id =  url.split("/")[-2]
             url =  f"https://pw-url-api-v1mf.onrender.com/process?v=https://sec1.pw.live/{vid_id}/master.mpd&quality={raw_text4}"
